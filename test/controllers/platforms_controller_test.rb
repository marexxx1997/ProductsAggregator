...
class PlatformsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create platform" do
    assert_difference('Platform.count') do
      post platforms_url, params: { platform: { logo_url: @platform.logo_url, name: @platform.name, url: @platform.url } }
    end
  ...
  test "should update platform" do
    patch platform_url(@platform), params: { platform: { logo_url: @platform.logo_url, name: @platform.name, url: @platform.url } }
