class PlatformsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @platform.save
        format.html { redirect_to platforms_index_url, notice: "Platform was successfully created." }
  ...
  def update
    respond_to do |format|
      if @platform.update(platform_params)
        format.html { redirect_to platforms_index_url, notice: "Platform was successfully updated." }
  ...
  private
    ...
    def platform_params
      params.require(:platform).permit(:name, :logo_url, :url)
    end
end
